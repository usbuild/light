...
#define GET_LOCAL_MSGID(x)                                                     \
  (static_cast<light::core::mq_handler_id_t>(x) &                              \
   ((~static_cast<light::core::mq_handler_id_t>(0)) >> sizeof(uint8_t)))
#define GET_STATION_ID(x)                                                      \
  (static_cast<light::core::mq_handler_id_t>(x) >>                             \
   (sizeof(light::core::mq_handler_id_t) - sizeof(uint8_t)))
