...
namespace light {
	namespace network {
		...
		INetEndPointIpV4::operator INetEndPoint() const {
			return INetEndPoint(*this);
		}

		light::utils::ErrorCode INetEndPointIpV4::parse_from_ip_port(const std::string& ip, int port) {
		...
		INetEndPointIpV6::operator INetEndPoint() const {
			return INetEndPoint(*this);
		}

		sa_family_t INetEndPoint::get_ip_version(const std::string& ip, light::utils::ErrorCode &ec) {
		...
		light::utils::ErrorCode INetEndPointIpV6::parse_from_ip_port(const std::string& ip, int port) {
			light::utils::ErrorCode ec;
			clear_sockaddr();
		...
		INetEndPoint::INetEndPoint(const INetEndPoint& src) {
			*this = src;
		}
		...
		INetEndPoint INetEndPoint::parse_from_ip_port(light::utils::ErrorCode &ec, const std::string& ip, int port) {
			INetEndPoint ret;
